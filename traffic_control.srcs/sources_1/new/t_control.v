...
module traffic_light_controller(nr,ny,ng,sr,sy,sg,er,ey,eg,wr,wy,wg,cin,rst_a);
   output wire nr,ny,ng,sr,sy,sg,er,ey,eg,wr,wy,wg;
   reg [2:0] n_lights,s_lights,e_lights,w_lights; 
   input cin;
   input      rst_a;
   wire clk;
   reg [2:0] state;
   clk_divider d(cin,clk);
